...
var possible_cases = [
						...
						// ,["true", "true","true","true", "true"], // biotico - abiotico - con fosiles - con reg sin fecha - con rango
						// ["true", "true","true","true", "false"], ["false", "true","true","true", "false"], // biotico - abiotico - con fosiles - con reg sin fecha - sin rango
						// ["true", "true","true","false", "true"], ["false", "true","true","false", "true"], // biotico - abiotico - con fosiles - sin reg sin fecha - con rango
						// ["true", "true","true","false", "false"], ["false", "true","true","false", "false"], // biotico - abiotico - con fosiles - sin reg sin fecha - sin rango


						// ["true", "true","false","true", "true"], ["false", "true","false","true", "true"], // biotico - abiotico - sin fosiles - con reg sin fecha - con rango
						// ["true", "true","false","true", "false"], ["false", "true","false","true", "false"], // biotico - abiotico - sin fosiles - con reg sin fecha - sin rango
						// ["true", "true","false","false", "true"], ["false", "true","false","false", "true"], // biotico - abiotico - sin fosiles - sin reg sin fecha - con rango
						// ["true", "true","false","false", "false"], ["false", "true","false","false", "false"], // biotico - abiotico - sin fosiles - sin reg sin fecha - sin rango
	...
	describe("Test get niche analysis (getGeoRel) endpoint - params(hasBio, hasRaster, fosil, sfecha, rango) => (" + params[0] + ", " + params[1] + ", " + params[2] + ", " + params[3] + ", " + params[4] + ")",function(){
		...
		it("Should get information about the result of a niche analysis such as ni, nj, nij, n, epsilon, score and so on.", function(done){
			...
			.end(function(err, res){
				...
				// console.log("especievalidabusqueda: " + res.body.data[random_index].especievalidabusqueda);
