...
with rawdata as (
	...
	--from iteratevalidationprocessbycells(5, 28923, 94544, 0.01, 0, array[]::int[], 'cells_16km', 'gridid_16km', 'grid_16km_aoi', 'where ordenvalido = ''Carnivora'' ', '', 'bio', false, -1, 2010, 2020, false, '', 'temp_01')
