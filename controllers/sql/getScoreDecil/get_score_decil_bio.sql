...
--from iteratevalidationprocessbydecil(5, 27604, 102388, 0.01, 0, array[]::int[], 'cells_8km', 'gridid_8km', 'grid_8km_aoi', 'where ordenvalido = ''Chiroptera'' ', '', 'bio', false, -1, 2010, 2020, '', 'temp_01', true)
-- 27332 28923
-- where layer = ''bio01'' 
