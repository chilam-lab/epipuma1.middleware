...
-- from iteratevalidationprocessbydecil(1, 28923, 94544, 0.01, 0, array[]::int[], 'cells_16km', 'gridid_16km', 'grid_16km_aoi', 'where clasevalida = ''Mammalia'' ', '', 'bio', false, -1, 2010, 2020, '', 'temp_01', false)
-- 27332 28923
-- where layer = ''bio01'' 
