...
from iteratevalidationprocessbydecil(5, 28923, 94544, 0.01, 0, array[]::int[], 'cells_64km', 'gridid_64km', 'grid_64km_aoi', 'where ordenvalido = ''Carnivora'' ', '', 'bio', false, -1, 2010, 2020, '', 'temp_01', false)
-- 27332 28923
-- where layer = ''bio01'' 
